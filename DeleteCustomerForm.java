...
class DeleteCustomerForm extends JFrame {
    ...
    public DeleteCustomerForm() {
        ...
        JLabel titleLabel = new JLabel("DELETE CUSTOMER FORM");
        ...
        btnDeleteCustomer.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                if (index != -1) {
                    CustomerMainForm.contactlist.deleteContact(index);
                    ...
                    JOptionPane.showMessageDialog(null, "No customer selected for deletion.", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
